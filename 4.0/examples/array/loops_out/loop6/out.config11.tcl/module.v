...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_1_scevgep_reg_stage66;
...
/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !8*/
...
/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !10, !legup.pipeline.stage !9*/
...
always @(*) begin
	...
	start_time: 0 avail_time: 2 stage: 0 II: 1 start_ii_state = 0 % 1 = 0 avail_ii_state = 2 % 1 = 0*/
		main_1_2 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* main: %1*/
	/*   %3 = add nsw i32 %2, 1, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !8, !legup.pipeline.stage !8
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_66) & loop6_1_valid_bit_67)))) begin
		loop6_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop6_1_started"); $finish; end
	end
end
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_65))) begin
		main_1_scevgep_reg_stage66 <= main_1_scevgep_reg_stage65;
		if (start == 1'b0 && ^(main_1_scevgep_reg_stage65) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_scevgep_reg_stage66"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_2))) begin
		main_1_2_reg_stage3 <= main_1_2;
		if (start == 1'b0 && ^(main_1_2) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_2_reg_stage3"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_3))) begin
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_33))) begin
		main_1_2_reg_stage34 <= main_1_2_reg_stage33;
		if (start == 1'b0 && ^(main_1_2_reg_stage33) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_2_reg_stage34"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	loop6_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_66) & loop6_1_valid_bit_67)));
end
always @(*) begin
	/* main: %1*/
	/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !8
	start_time: 2 avail_time: 34 stage: 2 II: 1 start_ii_state = 2 % 1 = 0 avail_ii_state = 34 % 1 = 0*/
...
always @(*) begin
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !10, !legup.pipeline.stage !9
	start_time: 34 avail_time: 66 stage: 34 II: 1 start_ii_state = 34 % 1 = 0 avail_ii_state = 66 % 1 = 0*/
		main_signed_divide_32_1_op0 = main_1_2_reg_stage34;
end
always @(*) begin
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !10, !legup.pipeline.stage !9
...
always @(*) begin
	...
	/* main: %1*/
	/*   store i32 %5, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !10, !legup.pipeline.avail_time !11, !legup.pipeline.stage !10
	start_time: 66 avail_time: 67 stage: 66 II: 1 start_ii_state = 66 % 1 = 0 avail_ii_state = 67 % 1 = 0*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_66)) begin
...
always @(*) begin
	...
	start_time: 66 avail_time: 67 stage: 66 II: 1 start_ii_state = 66 % 1 = 0 avail_ii_state = 67 % 1 = 0*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_66)) begin
		memory_controller_address_b = main_1_scevgep_reg_stage66;
	end
end
always @(*) begin
...
always @(*) begin
	...
	start_time: 66 avail_time: 67 stage: 66 II: 1 start_ii_state = 66 % 1 = 0 avail_ii_state = 67 % 1 = 0*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_66)) begin
		memory_controller_in_b = main_1_5;
	end
end
always @(*) begin
