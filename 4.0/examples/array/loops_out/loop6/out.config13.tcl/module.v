...
/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !12, !legup.pipeline.stage !13*/
...
always @(*) begin
	...
	start_time: 3 avail_time: 3 stage: 1 II: 3 start_ii_state = 3 % 3 = 0 avail_ii_state = 3 % 3 = 0*/
		main_1_scevgep = (1'd0 + (4 * main_1_i01_reg_stage1));
end
always @(posedge clk) begin
	/* main: %1*/
	/*   %scevgep = getelementptr [100 x i32]* @a, i32 0, i32 %i.01, !legup.pipeline.start_time !4, !legup.pipeline.avail_time !4, !legup.pipeline.stage !2
...
always @(*) begin
	/* main: %1*/
	/*   %3 = add nsw i32 %2, 1, !legup.pipeline.start_time !10, !legup.pipeline.avail_time !10, !legup.pipeline.stage !2
...
always @(posedge clk) begin
	...
	/*   %3 = add nsw i32 %2, 1, !legup.pipeline.start_time !10, !legup.pipeline.avail_time !10, !legup.pipeline.stage !2
	start_time: 5 avail_time: 5 stage: 1 II: 3 start_ii_state = 5 % 3 = 2 avail_ii_state = 5 % 3 = 2*/
	if ((~(memory_controller_waitrequest) & ((loop6_1_ii_state == 2'd2) & loop6_1_valid_bit_5))) begin
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !12, !legup.pipeline.stage !13
	start_time: 7 avail_time: 39 stage: 2 II: 3 start_ii_state = 7 % 3 = 1 avail_ii_state = 39 % 3 = 0*/
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !14, !legup.pipeline.stage !15
	start_time: 39 avail_time: 71 stage: 13 II: 3 start_ii_state = 39 % 3 = 0 avail_ii_state = 71 % 3 = 2*/
	if ((~(memory_controller_waitrequest) & ((loop6_1_ii_state == 2'd2) & loop6_1_valid_bit_71))) begin
...
always @(*) begin
	...
	/* main: %1*/
	/*   store i32 %5, i32* %scevgep, align 4, !tbaa !5, !legup.pipeline.start_time !14, !legup.pipeline.avail_time !16, !legup.pipeline.stage !17
	start_time: 71 avail_time: 72 stage: 23 II: 3 start_ii_state = 71 % 3 = 2 avail_ii_state = 72 % 3 = 0*/
	if (((loop6_1_ii_state == 2'd2) & loop6_1_valid_bit_71)) begin
		a_address_a = (main_1_scevgep_reg_stage23 >>> 3'd2);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_71) & loop6_1_valid_bit_72)))) begin
		loop6_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop6_1_started"); $finish; end
	end
end
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 2'd1) & loop6_1_valid_bit_4))) begin
...
always @(*) begin
	loop6_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_71) & loop6_1_valid_bit_72)));
end
always @(*) begin
	/* main: %1*/
	/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !12, !legup.pipeline.stage !13
	start_time: 7 avail_time: 39 stage: 2 II: 3 start_ii_state = 7 % 3 = 1 avail_ii_state = 39 % 3 = 0*/
	if (((loop6_1_ii_state == 2'd1) & loop6_1_valid_bit_7)) begin
		main_signed_divide_32_0_op0 = main_1_i01_reg_stage2;
	end
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !14, !legup.pipeline.stage !15
	start_time: 39 avail_time: 71 stage: 13 II: 3 start_ii_state = 39 % 3 = 0 avail_ii_state = 71 % 3 = 2*/
	else /* if (((loop6_1_ii_state == 2'd0) & loop6_1_valid_bit_39)) */ begin
		main_signed_divide_32_0_op0 = main_1_2_reg_stage13;
	end
end
always @(*) begin
	/* main: %1*/
