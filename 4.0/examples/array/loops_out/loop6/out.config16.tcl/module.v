...
reg [31:0] main_1_4_reg_stage17;
reg [31:0] main_1_5_reg_stage33;
...
/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !2, !legup.pipeline.avail_time !8, !legup.pipeline.stage !3*/
...
always @(posedge clk) begin
	...
	/*   %2 = load i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !3, !legup.pipeline.avail_time !2, !legup.pipeline.stage !3
	start_time: 0 avail_time: 1 stage: 0 II: 2 start_ii_state = 0 % 2 = 0 avail_ii_state = 1 % 2 = 1*/
	if ((~(memory_controller_waitrequest) & ((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_1))) begin
...
always @(*) begin
	/* main: %1*/
	/*   %3 = add nsw i32 %2, 1, !legup.pipeline.start_time !2, !legup.pipeline.avail_time !2, !legup.pipeline.stage !3
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !2, !legup.pipeline.avail_time !8, !legup.pipeline.stage !3
	start_time: 1 avail_time: 33 stage: 0 II: 2 start_ii_state = 1 % 2 = 1 avail_ii_state = 33 % 2 = 1*/
	if ((~(memory_controller_waitrequest) & ((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_33))) begin
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !10, !legup.pipeline.stage !11
	start_time: 34 avail_time: 66 stage: 17 II: 2 start_ii_state = 34 % 2 = 0 avail_ii_state = 66 % 2 = 0*/
	if ((~(memory_controller_waitrequest) & ((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_66))) begin
...
always @(*) begin
	...
	/* main: %1*/
	/*   store i32 %5, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !13, !legup.pipeline.stage !8
	start_time: 67 avail_time: 68 stage: 33 II: 2 start_ii_state = 67 % 2 = 1 avail_ii_state = 68 % 2 = 0*/
	if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_67)) begin
		a_address_a = (main_1_scevgep_reg_stage33 >>> 3'd2);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_67) & loop6_1_valid_bit_68)))) begin
		loop6_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop6_1_started"); $finish; end
	end
end
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_33))) begin
		main_1_4_reg_stage17 <= main_1_4;
		if (start == 1'b0 && ^(main_1_4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_4_reg_stage17"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_66))) begin
		main_1_5_reg_stage33 <= main_1_5;
		if (start == 1'b0 && ^(main_1_5) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_5_reg_stage33"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	loop6_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_67) & loop6_1_valid_bit_68)));
end
always @(*) begin
	/* main: %1*/
	/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !2, !legup.pipeline.avail_time !8, !legup.pipeline.stage !3
	start_time: 1 avail_time: 33 stage: 0 II: 2 start_ii_state = 1 % 2 = 1 avail_ii_state = 33 % 2 = 1*/
	if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_1)) begin
		main_signed_divide_32_0_op0 = main_1_i01_reg_stage0;
	end
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !10, !legup.pipeline.stage !11
	start_time: 34 avail_time: 66 stage: 17 II: 2 start_ii_state = 34 % 2 = 0 avail_ii_state = 66 % 2 = 0*/
	else /* if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_34)) */ begin
		main_signed_divide_32_0_op0 = main_1_2_reg_stage17;
	end
end
always @(*) begin
	/* main: %1*/
	...
	start_time: 34 avail_time: 66 stage: 17 II: 2 start_ii_state = 34 % 2 = 0 avail_ii_state = 66 % 2 = 0*/
		...
		main_signed_divide_32_0_op1 = main_1_4_reg_stage17;
	end
end
always @(*) begin
