...
reg [31:0] main_1_4_reg_stage18;
reg [31:0] main_1_5_reg_stage35;
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_69))) begin
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_36))) begin
		main_1_4_reg_stage18 <= main_1_4;
		if (start == 1'b0 && ^(main_1_4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_4_reg_stage18"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_69))) begin
		main_1_5_reg_stage35 <= main_1_5;
		if (start == 1'b0 && ^(main_1_5) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_5_reg_stage35"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	...
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_4)) begin
		main_signed_divide_32_0_op0 = main_1_i01_reg_stage2;
	end
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !13, !legup.pipeline.stage !14
	start_time: 37 avail_time: 69 stage: 18 II: 2 start_ii_state = 37 % 2 = 1 avail_ii_state = 69 % 2 = 1*/
	else /* if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_37)) */ begin
		main_signed_divide_32_0_op0 = main_1_2_reg_stage18;
	end
end
always @(*) begin
	/* main: %1*/
	...
	start_time: 37 avail_time: 69 stage: 18 II: 2 start_ii_state = 37 % 2 = 1 avail_ii_state = 69 % 2 = 1*/
		...
		main_signed_divide_32_0_op1 = main_1_4_reg_stage18;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/* main: %1*/
	/*   store i32 %5, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !15, !legup.pipeline.avail_time !16, !legup.pipeline.stage !17
	start_time: 70 avail_time: 71 stage: 35 II: 2 start_ii_state = 70 % 2 = 0 avail_ii_state = 71 % 2 = 1*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_70)) begin
...
always @(*) begin
	...
	start_time: 70 avail_time: 71 stage: 35 II: 2 start_ii_state = 70 % 2 = 0 avail_ii_state = 71 % 2 = 1*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_70)) begin
		memory_controller_address_b = main_1_scevgep_reg_stage35;
	end
end
always @(*) begin
...
always @(*) begin
	...
	start_time: 70 avail_time: 71 stage: 35 II: 2 start_ii_state = 70 % 2 = 0 avail_ii_state = 71 % 2 = 1*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_70)) begin
		memory_controller_in_b = main_1_5_reg_stage35;
	end
end
always @(*) begin
