...
always @(*) begin
	...
	/* main: %1*/
	/*   store i32 %5, i32* %scevgep, align 4, !tbaa !5, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !13, !legup.pipeline.stage !14
	start_time: 69 avail_time: 70 stage: 23 II: 3 start_ii_state = 69 % 3 = 0 avail_ii_state = 70 % 3 = 1*/
	if (((loop6_1_ii_state == 2'd0) & loop6_1_valid_bit_69)) begin
...
always @(*) begin
	...
	start_time: 69 avail_time: 70 stage: 23 II: 3 start_ii_state = 69 % 3 = 0 avail_ii_state = 70 % 3 = 1*/
	if (((loop6_1_ii_state == 2'd0) & loop6_1_valid_bit_69)) begin
		memory_controller_address_b = main_1_scevgep_reg_stage23;
	end
end
always @(*) begin
