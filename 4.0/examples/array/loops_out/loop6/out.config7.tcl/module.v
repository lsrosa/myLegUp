...
parameter [4:0] LEGUP_loop_pipeline_wait_loop6_1_8 = 5'd8;
parameter [4:0] LEGUP_F_main_BB_lrphipreheader_9 = 5'd9;
...
parameter [4:0] LEGUP_F_main_BB__54_16 = 5'd16;
parameter [4:0] LEGUP_F_main_BB__54_17 = 5'd17;
parameter [4:0] LEGUP_F_main_BB__54_18 = 5'd18;
parameter [4:0] LEGUP_F_main_BB__54_19 = 5'd19;
parameter [4:0] LEGUP_F_main_BB__54_20 = 5'd20;
parameter [4:0] LEGUP_F_main_BB__60_21 = 5'd21;
parameter [4:0] LEGUP_F_main_BB__62_22 = 5'd22;
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB__60_21)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %62*/
...
LEGUP_0:
	if ((start == 1'd1))
		next_state = LEGUP_loop_pipeline_wait_loop6_1_8;
LEGUP_F_main_BB__54_16:
		next_state = LEGUP_F_main_BB__54_17;
LEGUP_F_main_BB__54_17:
		next_state = LEGUP_F_main_BB__54_18;
LEGUP_F_main_BB__54_18:
		next_state = LEGUP_F_main_BB__54_19;
LEGUP_F_main_BB__54_19:
		next_state = LEGUP_F_main_BB__54_20;
LEGUP_F_main_BB__54_20:
	if ((main_54_exitcond1_reg == 1'd1))
		next_state = LEGUP_F_main_BB_lrphipreheader_9;
...
LEGUP_F_main_BB_lrphipreheader_9:
...
LEGUP_F_main_BB_preheader2_7:
		next_state = LEGUP_F_main_BB__54_16;
LEGUP_loop_pipeline_wait_loop6_1_8:
...
always @(*) begin
	/* main: %13*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %13 ], [ 0, %0 ], !legup.canonical_induction !6, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
	start_time: 0 avail_time: 0 stage: 0 II: 1 start_ii_state = 0 % 1 = 0 avail_ii_state = 0 % 1 = 0*/
if (reset) begin main_13_indvar4 = 0; end
...
always @(*) begin
	...
	start_time: 0 avail_time: 0 stage: 0 II: 1 start_ii_state = 0 % 1 = 0 avail_ii_state = 0 % 1 = 0*/
		main_13_scevgep6 = (1'd0 + (4 * main_13_i010));
end
always @(posedge clk) begin
	/* main: %13*/
	/*   %scevgep6 = getelementptr [100 x i32]* @array, i32 0, i32 %i.010, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
...
always @(*) begin
	/* main: %13*/
	/*   %14 = add i32 %indvar4, 4, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
	start_time: 0 avail_time: 0 stage: 0 II: 1 start_ii_state = 0 % 1 = 0 avail_ii_state = 0 % 1 = 0*/
...
always @(posedge clk) begin
	/* main: %13*/
	/*   %15 = mul nsw i32 %14, %i.010, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !6, !legup.pipeline.stage !7
...
always @(*) begin
	/* main: %13*/
	/*   %16 = add nsw i32 %15, -19, !legup.pipeline.start_time !6, !legup.pipeline.avail_time !6, !legup.pipeline.stage !6
...
always @(*) begin
	/* main: %13*/
	/*   %indvar.next5 = add i32 %indvar4, 1, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
	start_time: 0 avail_time: 0 stage: 0 II: 1 start_ii_state = 0 % 1 = 0 avail_ii_state = 0 % 1 = 0*/
		main_13_indvarnext5 = (loop6_1_i_stage0 + 32'd1);
end
always @(posedge clk) begin
	/* main: %13*/
	/*   %indvar.next5 = add i32 %indvar4, 1, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
...
always @(*) begin
		main_13_exitcond = loop6_1_pipeline_finish;
end
always @(posedge clk) begin
	if ((cur_state == LEGUP_loop_pipeline_wait_loop6_1_8)) begin
		main_13_exitcond_reg <= loop6_1_pipeline_finish;
		if (start == 1'b0 && ^(loop6_1_pipeline_finish) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_13_exitcond_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %.lr.ph.i.preheader*/
...
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %17 = add nsw i32 %2, %1*/
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_9)) begin
...
always @(*) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %18 = add nsw i32 %3, %17*/
		main_lrphipreheader_18 = (main_preheader2_3_reg + main_lrphipreheader_17);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %18 = add nsw i32 %3, %17*/
...
always @(*) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %19 = add nsw i32 %4, %18*/
		main_lrphipreheader_19 = (main_preheader2_4_reg + main_lrphipreheader_18);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %19 = add nsw i32 %4, %18*/
...
always @(*) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %23 = add nsw i32 %8, %22*/
		main_lrphipreheader_23 = (main_preheader2_8_reg + main_lrphipreheader_22);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %23 = add nsw i32 %8, %22*/
...
always @(*) begin
	...
	/*   %25 = add nsw i32 %10, %24*/
		main_lrphipreheader_25 = (main_preheader2_10_reg + main_lrphipreheader_24);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %25 = add nsw i32 %10, %24*/
...
always @(*) begin
	...
	/*   %27 = add nsw i32 %12, %26*/
		main_lrphipreheader_27 = (main_preheader2_12_reg + main_lrphipreheader_26);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %27 = add nsw i32 %12, %26*/
...
always @(*) begin
	...
	/*   %32 = add nsw i32 %31, %30*/
		main_lrphipreheader_32 = (main_lrphipreheader_31 + main_lrphipreheader_30_reg);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %32 = add nsw i32 %31, %30*/
...
always @(*) begin
	...
	/*   %34 = add nsw i32 %33, %32*/
		main_lrphipreheader_34 = (main_lrphipreheader_33 + main_lrphipreheader_32);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %34 = add nsw i32 %33, %32*/
...
always @(*) begin
	...
	/*   %36 = add nsw i32 %35, %34*/
		main_lrphipreheader_36 = (main_lrphipreheader_35 + main_lrphipreheader_34_reg);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %36 = add nsw i32 %35, %34*/
...
always @(*) begin
	...
	/*   %38 = add nsw i32 %37, %36*/
		main_lrphipreheader_38 = (main_lrphipreheader_37 + main_lrphipreheader_36);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %38 = add nsw i32 %37, %36*/
...
always @(*) begin
	...
	/*   %40 = add nsw i32 %39, %38*/
		main_lrphipreheader_40 = (main_lrphipreheader_39 + main_lrphipreheader_38_reg);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %40 = add nsw i32 %39, %38*/
...
always @(*) begin
	...
	/*   %42 = add nsw i32 %41, %40*/
		main_lrphipreheader_42 = (main_lrphipreheader_41 + main_lrphipreheader_40);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %42 = add nsw i32 %41, %40*/
...
always @(*) begin
	...
	/*   %44 = add nsw i32 %43, %42*/
		main_lrphipreheader_44 = (main_lrphipreheader_43 + main_lrphipreheader_42_reg);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %44 = add nsw i32 %43, %42*/
...
always @(*) begin
	...
	/*   %46 = add nsw i32 %45, %44*/
		main_lrphipreheader_46 = (main_lrphipreheader_45 + main_lrphipreheader_44);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %46 = add nsw i32 %45, %44*/
...
always @(*) begin
	...
	/*   %48 = add nsw i32 %47, %46*/
		main_lrphipreheader_48 = (main_lrphipreheader_47 + main_lrphipreheader_46_reg);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %48 = add nsw i32 %47, %46*/
...
always @(*) begin
	...
	/*   %50 = add nsw i32 %49, %48*/
		main_lrphipreheader_50 = (main_lrphipreheader_49 + main_lrphipreheader_48);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %50 = add nsw i32 %49, %48*/
...
always @(*) begin
	...
	/* main: %54*/
	/*   %indvar = phi i32 [ %indvar.next, %54 ], [ 0, %.preheader2 ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__54_20) & (memory_controller_waitrequest == 1'd0)) & (main_54_exitcond1_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* main: %54*/
	/*   %indvar = phi i32 [ %indvar.next, %54 ], [ 0, %.preheader2 ]*/
	if ((((cur_state == LEGUP_F_main_BB__54_20) & (memory_controller_waitrequest == 1'd0)) & (main_54_exitcond1_reg == 1'd0))) begin
		main_54_indvar_reg <= main_54_indvar;
		if (start == 1'b0 && ^(main_54_indvar) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_indvar_reg"); $finish; end
	end
end
...
always @(posedge clk) begin
	/* main: %54*/
	/*   %55 = add i32 %indvar, 1*/
	if ((cur_state == LEGUP_F_main_BB__54_16)) begin
...
always @(*) begin
	...
	/*   %scevgep = getelementptr [100 x i32]* @array, i32 0, i32 %55*/
		main_54_scevgep = (1'd0 + (4 * main_54_55_reg));
end
always @(posedge clk) begin
	/* main: %54*/
	/*   %scevgep = getelementptr [100 x i32]* @array, i32 0, i32 %55*/
	if ((cur_state == LEGUP_F_main_BB__54_17)) begin
...
always @(*) begin
	...
	/*   %scevgep2 = getelementptr [100 x i32]* @array, i32 0, i32 %indvar*/
		main_54_scevgep2 = (1'd0 + (4 * main_54_indvar_reg));
end
always @(posedge clk) begin
	/* main: %54*/
	/*   %scevgep2 = getelementptr [100 x i32]* @array, i32 0, i32 %indvar*/
...
always @(*) begin
	...
	/*   %scevgep3 = getelementptr [100 x i32]* @array, i32 0, i32 %56*/
		main_54_scevgep3 = (1'd0 + (4 * main_54_56_reg));
end
always @(posedge clk) begin
	/* main: %54*/
	/*   %scevgep3 = getelementptr [100 x i32]* @array, i32 0, i32 %56*/
...
always @(*) begin
	...
	/*   %57 = load i32* %scevgep3, align 4, !tbaa !2*/
		main_54_57 = array_out_b;
end
always @(posedge clk) begin
	/* main: %54*/
	/*   %57 = load i32* %scevgep3, align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB__54_18)) begin
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB__54_19)) begin
...
always @(*) begin
	...
	/* main: %13*/
	/*   store i32 %16, i32* %scevgep6, align 4, !tbaa !2, !legup.pipeline.start_time !6, !legup.pipeline.avail_time !8, !legup.pipeline.stage !6
	start_time: 1 avail_time: 2 stage: 1 II: 1 start_ii_state = 1 % 1 = 0 avail_ii_state = 2 % 1 = 0*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_1)) begin
		array_address_a = (main_13_scevgep6_reg_stage1 >>> 3'd2);
	end
	/* main: %.lr.ph.i.preheader*/
	/*   %28 = load i32* getelementptr inbounds ([100 x i32]* @array, i32 0, i32 0), align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_9)) begin
	...
	if ((cur_state == LEGUP_F_main_BB__54_19)) begin
		array_address_a = (main_54_scevgep_reg >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %58 = load i32* %scevgep2, align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB__54_16)) begin
		array_address_b = (main_54_scevgep2 >>> 3'd2);
	end
	/* main: %54*/
	/*   %57 = load i32* %scevgep3, align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB__54_17)) begin
		array_address_b = (main_54_scevgep3 >>> 3'd2);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_1) & loop6_1_valid_bit_2)))) begin
		loop6_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop6_1_started"); $finish; end
	end
end
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_0))) begin
		main_13_scevgep6_reg_stage1 <= main_13_scevgep6;
		if (start == 1'b0 && ^(main_13_scevgep6) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_13_scevgep6_reg_stage1"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	loop6_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_1) & loop6_1_valid_bit_2)));
end
always @(*) begin
