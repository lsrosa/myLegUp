...
/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !2*/
...
always @(*) begin
	/* main: %1*/
	/*   %3 = add nsw i32 %2, 1, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !8, !legup.pipeline.stage !2
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_68) & loop6_1_valid_bit_69)))) begin
		loop6_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop6_1_started"); $finish; end
	end
end
...
always @(*) begin
	loop6_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop6_1_epilogue & (~(loop6_1_valid_bit_68) & loop6_1_valid_bit_69)));
end
always @(*) begin
	/* main: %1*/
	/*   %4 = sdiv i32 %i.01, %3, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !2
	start_time: 2 avail_time: 34 stage: 1 II: 2 start_ii_state = 2 % 2 = 0 avail_ii_state = 34 % 2 = 0*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_2)) begin
	...
	start_time: 35 avail_time: 67 stage: 17 II: 2 start_ii_state = 35 % 2 = 1 avail_ii_state = 67 % 2 = 1*/
	else /* if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_35)) */ begin
...
always @(*) begin
	...
	/* main: %1*/
	/*   store i32 %5, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !13, !legup.pipeline.avail_time !14, !legup.pipeline.stage !9
	start_time: 68 avail_time: 69 stage: 34 II: 2 start_ii_state = 68 % 2 = 0 avail_ii_state = 69 % 2 = 1*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_68)) begin
...
always @(*) begin
	...
	start_time: 68 avail_time: 69 stage: 34 II: 2 start_ii_state = 68 % 2 = 0 avail_ii_state = 69 % 2 = 1*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_68)) begin
		memory_controller_address_b = main_1_scevgep_reg_stage34;
	end
end
always @(*) begin
...
always @(*) begin
	...
	start_time: 68 avail_time: 69 stage: 34 II: 2 start_ii_state = 68 % 2 = 0 avail_ii_state = 69 % 2 = 1*/
	if (((loop6_1_ii_state == 1'd0) & loop6_1_valid_bit_68)) begin
		memory_controller_in_b = main_1_5_reg_stage34;
	end
end
always @(*) begin
