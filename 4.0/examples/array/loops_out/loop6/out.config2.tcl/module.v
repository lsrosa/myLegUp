...
always @(*) begin
	...
	/* main: %54*/
	/*   %indvar = phi i32 [ %indvar.next, %54 ], [ 0, %.preheader2 ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__54_25) & (memory_controller_waitrequest == 1'd0)) & (main_54_exitcond1_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* main: %54*/
	/*   %indvar = phi i32 [ %indvar.next, %54 ], [ 0, %.preheader2 ]*/
	if ((((cur_state == LEGUP_F_main_BB__54_25) & (memory_controller_waitrequest == 1'd0)) & (main_54_exitcond1_reg == 1'd0))) begin
		main_54_indvar_reg <= main_54_indvar;
		if (start == 1'b0 && ^(main_54_indvar) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_indvar_reg"); $finish; end
	end
end
...
always @(*) begin
	...
	start_time: 1 avail_time: 2 stage: 0 II: 2 start_ii_state = 1 % 2 = 1 avail_ii_state = 2 % 2 = 0*/
	if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_1)) begin
		memory_controller_address_a = main_13_scevgep6_reg_stage0;
	end
	/* main: %.lr.ph.i.preheader*/
	/*   %28 = load i32* getelementptr inbounds ([100 x i32]* @array, i32 0, i32 0), align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_10)) begin
