...
parameter [4:0] LEGUP_F_main_BB__60_24 = 5'd24;
parameter [4:0] LEGUP_F_main_BB__62_25 = 5'd25;
parameter [4:0] LEGUP_F_main_BB__64_26 = 5'd26;
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB__60_24)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %62*/
	/*   %63 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str8, i32 0, i32 0)) #2*/
	if ((cur_state == LEGUP_F_main_BB__62_25)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB__60_24:
		next_state = LEGUP_F_main_BB__64_26;
LEGUP_F_main_BB__62_25:
		next_state = LEGUP_F_main_BB__64_26;
LEGUP_F_main_BB__64_26:
		next_state = LEGUP_0;
...
LEGUP_F_main_BB_lrphipreheader_17:
	if ((main_lrphipreheader_53 == 1'd1))
		next_state = LEGUP_F_main_BB__60_24;
	else if ((main_lrphipreheader_53 == 1'd0))
		next_state = LEGUP_F_main_BB__62_25;
...
always @(*) begin
	...
	/* main: %54*/
	/*   %indvar = phi i32 [ %indvar.next, %54 ], [ 0, %.preheader2 ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__54_23) & (memory_controller_waitrequest == 1'd0)) & (main_54_exitcond1_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* main: %54*/
	/*   %indvar = phi i32 [ %indvar.next, %54 ], [ 0, %.preheader2 ]*/
	if ((((cur_state == LEGUP_F_main_BB__54_23) & (memory_controller_waitrequest == 1'd0)) & (main_54_exitcond1_reg == 1'd0))) begin
		main_54_indvar_reg <= main_54_indvar;
		if (start == 1'b0 && ^(main_54_indvar) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_indvar_reg"); $finish; end
	end
end
...
always @(posedge clk) begin
	...
	/* main: %64*/
	/*   ret i32 %51*/
	if ((cur_state == LEGUP_F_main_BB__64_26)) begin
...
always @(*) begin
	...
	if ((cur_state == LEGUP_F_main_BB__54_22)) begin
		memory_controller_enable_a = 1'd1;
	end
end
always @(*) begin
