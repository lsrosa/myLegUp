...
parameter [4:0] LEGUP_F_main_BB__54_21 = 5'd21;
parameter [4:0] LEGUP_F_main_BB__54_22 = 5'd22;
parameter [4:0] LEGUP_F_main_BB__60_23 = 5'd23;
parameter [4:0] LEGUP_F_main_BB__62_24 = 5'd24;
parameter [4:0] LEGUP_F_main_BB__64_25 = 5'd25;
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB__60_23)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %62*/
	/*   %63 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str8, i32 0, i32 0)) #2*/
	if ((cur_state == LEGUP_F_main_BB__62_24)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB__54_20:
		next_state = LEGUP_F_main_BB__54_21;
LEGUP_F_main_BB__54_21:
		next_state = LEGUP_F_main_BB__54_22;
LEGUP_F_main_BB__54_22:
...
LEGUP_F_main_BB__60_23:
		next_state = LEGUP_F_main_BB__64_25;
LEGUP_F_main_BB__62_24:
		next_state = LEGUP_F_main_BB__64_25;
LEGUP_F_main_BB__64_25:
		next_state = LEGUP_0;
...
LEGUP_F_main_BB_lrphipreheader_17:
	if ((main_lrphipreheader_53 == 1'd1))
		next_state = LEGUP_F_main_BB__60_23;
	else if ((main_lrphipreheader_53 == 1'd0))
		next_state = LEGUP_F_main_BB__62_24;
...
always @(*) begin
	/* main: %13*/
	/*   %16 = add nsw i32 %15, -19, !legup.pipeline.start_time !6, !legup.pipeline.avail_time !6, !legup.pipeline.stage !7
...
always @(*) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %21 = add nsw i32 %6, %20*/
		main_lrphipreheader_21 = (main_preheader2_6_reg + main_lrphipreheader_20);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %21 = add nsw i32 %6, %20*/
...
always @(*) begin
	...
	/*   %36 = add nsw i32 %35, %34*/
		main_lrphipreheader_36 = (main_lrphipreheader_35 + main_lrphipreheader_34);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %36 = add nsw i32 %35, %34*/
...
always @(*) begin
	...
	/*   %42 = add nsw i32 %41, %40*/
		main_lrphipreheader_42 = (main_lrphipreheader_41_reg + main_lrphipreheader_40);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %42 = add nsw i32 %41, %40*/
...
always @(*) begin
	...
	/*   %46 = add nsw i32 %45, %44*/
		main_lrphipreheader_46 = (main_lrphipreheader_45_reg + main_lrphipreheader_44);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %46 = add nsw i32 %45, %44*/
...
always @(*) begin
	...
	/*   %50 = add nsw i32 %49, %48*/
		main_lrphipreheader_50 = (main_lrphipreheader_49_reg + main_lrphipreheader_48);
end
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %50 = add nsw i32 %49, %48*/
...
always @(*) begin
	...
	/* main: %54*/
	/*   %indvar = phi i32 [ %indvar.next, %54 ], [ 0, %.preheader2 ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__54_22) & (memory_controller_waitrequest == 1'd0)) & (main_54_exitcond1_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* main: %54*/
	/*   %indvar = phi i32 [ %indvar.next, %54 ], [ 0, %.preheader2 ]*/
	if ((((cur_state == LEGUP_F_main_BB__54_22) & (memory_controller_waitrequest == 1'd0)) & (main_54_exitcond1_reg == 1'd0))) begin
		main_54_indvar_reg <= main_54_indvar;
		if (start == 1'b0 && ^(main_54_indvar) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_indvar_reg"); $finish; end
	end
end
...
always @(posedge clk) begin
	/* main: %54*/
	/*   %57 = load i32* %scevgep3, align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB__54_20)) begin
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB__54_21)) begin
...
always @(*) begin
	...
	/* main: %13*/
	/*   store i32 %16, i32* %scevgep6, align 4, !tbaa !2, !legup.pipeline.start_time !6, !legup.pipeline.avail_time !8, !legup.pipeline.stage !7
	...
	if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_1)) begin
		array_address_a = (main_13_scevgep6_reg_stage0 >>> 3'd2);
	end
	/* main: %.lr.ph.i.preheader*/
	/*   %28 = load i32* getelementptr inbounds ([100 x i32]* @array, i32 0, i32 0), align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_9)) begin
...
always @(posedge clk) begin
	...
	/* main: %64*/
	/*   ret i32 %51*/
	if ((cur_state == LEGUP_F_main_BB__64_25)) begin
