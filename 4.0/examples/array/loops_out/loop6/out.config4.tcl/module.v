...
always @(*) begin
	...
	/* main: %1*/
	/*   store i32 %5, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !13, !legup.pipeline.stage !14
...
always @(*) begin
	...
	start_time: 67 avail_time: 68 stage: 33 II: 2 start_ii_state = 67 % 2 = 1 avail_ii_state = 68 % 2 = 0*/
	if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_67)) begin
		memory_controller_address_a = main_1_scevgep_reg_stage33;
	end
end
always @(*) begin
...
always @(*) begin
	...
	start_time: 67 avail_time: 68 stage: 33 II: 2 start_ii_state = 67 % 2 = 1 avail_ii_state = 68 % 2 = 0*/
	if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_67)) begin
		memory_controller_in_a = main_1_5;
	end
end
always @(*) begin
