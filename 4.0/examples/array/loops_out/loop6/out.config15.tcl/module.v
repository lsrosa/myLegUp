...
/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !10*/
...
always @(posedge clk) begin
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !10
	start_time: 33 avail_time: 65 stage: 16 II: 2 start_ii_state = 33 % 2 = 1 avail_ii_state = 65 % 2 = 1*/
	if ((~(memory_controller_waitrequest) & ((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_65))) begin
...
always @(*) begin
	...
	/* main: %1*/
	/*   store i32 %5, i32* %scevgep, align 4, !tbaa !4, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !11, !legup.pipeline.stage !12
	start_time: 65 avail_time: 66 stage: 32 II: 2 start_ii_state = 65 % 2 = 1 avail_ii_state = 66 % 2 = 0*/
	if (((loop6_1_ii_state == 1'd1) & loop6_1_valid_bit_65)) begin
		a_address_a = (main_1_scevgep_reg_stage32 >>> 3'd2);
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !10
	start_time: 33 avail_time: 65 stage: 16 II: 2 start_ii_state = 33 % 2 = 1 avail_ii_state = 65 % 2 = 1*/
		main_signed_divide_32_1_op0 = main_1_2_reg_stage16;
end
always @(*) begin
	/* main: %1*/
	/*   %5 = sdiv i32 %2, %4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !10
