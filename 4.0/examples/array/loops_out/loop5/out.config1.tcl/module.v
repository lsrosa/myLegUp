...
parameter [4:0] LEGUP_F_main_BB__13_9 = 5'd9;
parameter [4:0] LEGUP_F_main_BB__13_10 = 5'd10;
parameter [4:0] LEGUP_F_main_BB__13_11 = 5'd11;
...
parameter [4:0] LEGUP_F_main_BB_lrphipreheader_23 = 5'd23;
parameter [4:0] LEGUP_F_main_BB_lrphipreheader_24 = 5'd24;
parameter [4:0] LEGUP_loop_pipeline_wait_loop5_1_25 = 5'd25;
parameter [4:0] LEGUP_F_main_BB__60_26 = 5'd26;
parameter [4:0] LEGUP_F_main_BB__62_27 = 5'd27;
parameter [4:0] LEGUP_F_main_BB__64_28 = 5'd28;
...
reg  loop5_1_valid_bit_7;
reg  loop5_1_valid_bit_8;
reg [31:0] main_54_55_reg_stage0;
...
reg [31:0] main_54_57_reg_stage0;
reg [31:0] main_54_57_reg_stage1;
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB__60_26)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %62*/
...
LEGUP_F_main_BB__13_11:
	if ((main_13_exitcond_reg == 1'd1))
		next_state = LEGUP_F_main_BB_preheader2_1;
	else if ((main_13_exitcond_reg == 1'd0))
		next_state = LEGUP_F_main_BB__13_9;
LEGUP_F_main_BB__13_9:
		next_state = LEGUP_F_main_BB__13_10;
LEGUP_F_main_BB__60_26:
		next_state = LEGUP_F_main_BB__64_28;
LEGUP_F_main_BB__62_27:
		next_state = LEGUP_F_main_BB__64_28;
LEGUP_F_main_BB__64_28:
		next_state = LEGUP_0;
...
LEGUP_F_main_BB_lrphipreheader_24:
	if ((main_lrphipreheader_53 == 1'd1))
		next_state = LEGUP_F_main_BB__60_26;
...
LEGUP_F_main_BB_preheader2_8:
		next_state = LEGUP_loop_pipeline_wait_loop5_1_25;
LEGUP_loop_pipeline_wait_loop5_1_25:
...
always @(*) begin
	...
	/* main: %13*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %13 ], [ 0, %0 ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__13_11) & (memory_controller_waitrequest == 1'd0)) & (main_13_exitcond_reg == 1'd0))) */ begin
		main_13_indvar4 = main_13_indvarnext5_reg;
	end
end
always @(posedge clk) begin
	/* main: %13*/
	...
	/* main: %13*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %13 ], [ 0, %0 ]*/
	if ((((cur_state == LEGUP_F_main_BB__13_11) & (memory_controller_waitrequest == 1'd0)) & (main_13_exitcond_reg == 1'd0))) begin
		main_13_indvar4_reg <= main_13_indvar4;
		if (start == 1'b0 && ^(main_13_indvar4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_13_indvar4_reg"); $finish; end
	end
end
...
always @(*) begin
	...
	/*   %scevgep6 = getelementptr [100 x i32]* @array, i32 0, i32 %i.010*/
		main_13_scevgep6 = (`TAG_g_array_a + (4 * main_13_i010_reg));
end
always @(*) begin
	/* main: %13*/
...
always @(*) begin
	/* main: %54*/
	/*   %55 = add i32 %indvar, 1, !legup.pipeline.start_time !6, !legup.pipeline.avail_time !6, !legup.pipeline.stage !7
	start_time: 1 avail_time: 1 stage: 0 II: 4 start_ii_state = 1 % 4 = 1 avail_ii_state = 1 % 4 = 1*/
		main_54_55 = (loop5_1_i_stage0 + 32'd1);
end
always @(*) begin
	/* main: %54*/
	/*   %scevgep = getelementptr [100 x i32]* @array, i32 0, i32 %55, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !8, !legup.pipeline.stage !6
	start_time: 4 avail_time: 4 stage: 1 II: 4 start_ii_state = 4 % 4 = 0 avail_ii_state = 4 % 4 = 0*/
		main_54_scevgep = (`TAG_g_array_a + (4 * main_54_55_reg_stage1));
end
always @(*) begin
	/* main: %54*/
	...
	start_time: 0 avail_time: 0 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 0 % 4 = 0*/
		main_54_scevgep2 = (`TAG_g_array_a + (4 * loop5_1_i_stage0));
end
always @(*) begin
	/* main: %54*/
	/*   %56 = add i32 %indvar, 2, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
	start_time: 0 avail_time: 0 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 0 % 4 = 0*/
		main_54_56 = (loop5_1_i_stage0 + 32'd2);
end
always @(*) begin
	/* main: %54*/
	/*   %scevgep3 = getelementptr [100 x i32]* @array, i32 0, i32 %56, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
	start_time: 0 avail_time: 0 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 0 % 4 = 0*/
		main_54_scevgep3 = (`TAG_g_array_a + (4 * main_54_56));
end
always @(*) begin
	/* main: %54*/
	/*   %57 = load i32* %scevgep3, align 4, !tbaa !2, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !9, !legup.pipeline.stage !7
	start_time: 0 avail_time: 2 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 2 % 4 = 2*/
		main_54_57 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* main: %54*/
	/*   %58 = load i32* %scevgep2, align 4, !tbaa !2, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !10, !legup.pipeline.stage !6
	start_time: 4 avail_time: 6 stage: 1 II: 4 start_ii_state = 4 % 4 = 0 avail_ii_state = 6 % 4 = 2*/
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop5_1_epilogue & (~(loop5_1_valid_bit_7) & loop5_1_valid_bit_8)))) begin
		loop5_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_started"); $finish; end
	end
end
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop5_1_ii_state == 2'd2))) begin
		loop5_1_ii_state <= 2'd3;
		if (start == 1'b0 && ^(2'd3) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_ii_state"); $finish; end
	end
	if (((memory_controller_waitrequest == 1'd0) & (loop5_1_ii_state == 2'd3))) begin
		loop5_1_ii_state <= 2'd0;
		if (start == 1'b0 && ^(2'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_ii_state"); $finish; end
	end
end
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (((memory_controller_waitrequest == 1'd0) & (loop5_1_ii_state == 2'd3)) & loop5_1_valid_bit_3))) begin
...
always @(posedge clk) begin
	if ((memory_controller_waitrequest == 1'd0)) begin
		loop5_1_valid_bit_7 <= loop5_1_valid_bit_6;
		if (start == 1'b0 && ^(loop5_1_valid_bit_6) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_valid_bit_7"); $finish; end
	end
	if (reset) begin
		loop5_1_valid_bit_7 <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_valid_bit_7"); $finish; end
	end
end
always @(posedge clk) begin
	if ((memory_controller_waitrequest == 1'd0)) begin
		loop5_1_valid_bit_8 <= loop5_1_valid_bit_7;
		if (start == 1'b0 && ^(loop5_1_valid_bit_7) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_valid_bit_8"); $finish; end
	end
	if (reset) begin
		loop5_1_valid_bit_8 <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_valid_bit_8"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop5_1_ii_state == 2'd1) & loop5_1_valid_bit_1))) begin
		main_54_55_reg_stage0 <= main_54_55;
		if (start == 1'b0 && ^(main_54_55) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_55_reg_stage0"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop5_1_ii_state == 2'd3) & loop5_1_valid_bit_3))) begin
		main_54_55_reg_stage1 <= main_54_55_reg_stage0;
		if (start == 1'b0 && ^(main_54_55_reg_stage0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_55_reg_stage1"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop5_1_ii_state == 2'd0) & loop5_1_valid_bit_4))) begin
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop5_1_ii_state == 2'd2) & loop5_1_valid_bit_2))) begin
		main_54_57_reg_stage0 <= main_54_57;
		if (start == 1'b0 && ^(main_54_57) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_57_reg_stage0"); $finish; end
	end
end
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop5_1_ii_state == 2'd3) & loop5_1_valid_bit_3))) begin
		main_54_57_reg_stage1 <= main_54_57_reg_stage0;
		if (start == 1'b0 && ^(main_54_57_reg_stage0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_57_reg_stage1"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	loop5_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop5_1_epilogue & (~(loop5_1_valid_bit_7) & loop5_1_valid_bit_8)));
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_13_15_en == 1'd1)) begin
		main_13_15_stage0_reg <= (main_13_14 * main_13_i010);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	start_time: 6 avail_time: 7 stage: 1 II: 4 start_ii_state = 6 % 4 = 2 avail_ii_state = 7 % 4 = 3*/
	if ((lpm_mult_main_54_59_en == 1'd1)) begin
		main_54_59_stage0_reg <= (main_54_58 * main_54_57_reg_stage1);
	end
end
always @(posedge clk) begin
	...
	/* main: %64*/
	/*   ret i32 %51*/
	if ((cur_state == LEGUP_F_main_BB__64_28)) begin
...
always @(*) begin
	...
	/*   %57 = load i32* %scevgep3, align 4, !tbaa !2, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !9, !legup.pipeline.stage !7
	start_time: 0 avail_time: 2 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 2 % 4 = 2*/
	if (((loop5_1_ii_state == 2'd0) & loop5_1_valid_bit_0)) begin
		memory_controller_enable_a = 1'd1;
	end
end
always @(*) begin
	...
	/*   store i32 %16, i32* %scevgep6, align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB__13_10)) begin
		memory_controller_address_a = main_13_scevgep6;
	end
	/* main: %.lr.ph.i.preheader*/
	/*   %28 = load i32* getelementptr inbounds ([100 x i32]* @array, i32 0, i32 0), align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_12)) begin
	...
	start_time: 0 avail_time: 2 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 2 % 4 = 2*/
	if (((loop5_1_ii_state == 2'd0) & loop5_1_valid_bit_0)) begin
		memory_controller_address_a = main_54_scevgep3;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %58 = load i32* %scevgep2, align 4, !tbaa !2, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !10, !legup.pipeline.stage !6
	start_time: 4 avail_time: 6 stage: 1 II: 4 start_ii_state = 4 % 4 = 0 avail_ii_state = 6 % 4 = 2*/
	if (((loop5_1_ii_state == 2'd0) & loop5_1_valid_bit_4)) begin
		memory_controller_enable_b = 1'd1;
	end
	/* main: %54*/
	/*   store i32 %59, i32* %scevgep, align 4, !tbaa !2, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !12, !legup.pipeline.stage !6
	start_time: 7 avail_time: 8 stage: 1 II: 4 start_ii_state = 7 % 4 = 3 avail_ii_state = 8 % 4 = 0*/
	if (((loop5_1_ii_state == 2'd3) & loop5_1_valid_bit_7)) begin
		memory_controller_enable_b = 1'd1;
	end
end
always @(*) begin
	...
	start_time: 4 avail_time: 6 stage: 1 II: 4 start_ii_state = 4 % 4 = 0 avail_ii_state = 6 % 4 = 2*/
	if (((loop5_1_ii_state == 2'd0) & loop5_1_valid_bit_4)) begin
		memory_controller_address_b = main_54_scevgep2_reg_stage1;
	end
	/* main: %54*/
	/*   store i32 %59, i32* %scevgep, align 4, !tbaa !2, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !12, !legup.pipeline.stage !6
	start_time: 7 avail_time: 8 stage: 1 II: 4 start_ii_state = 7 % 4 = 3 avail_ii_state = 8 % 4 = 0*/
	if (((loop5_1_ii_state == 2'd3) & loop5_1_valid_bit_7)) begin
		memory_controller_address_b = main_54_scevgep_reg_stage1;
	end
end
always @(*) begin
...
always @(*) begin
	...
	start_time: 7 avail_time: 8 stage: 1 II: 4 start_ii_state = 7 % 4 = 3 avail_ii_state = 8 % 4 = 0*/
	if (((loop5_1_ii_state == 2'd3) & loop5_1_valid_bit_7)) begin
		memory_controller_in_b = main_54_59;
	end
end
always @(*) begin
