...
parameter [5:0] LEGUP_F_main_BB_preheader2_8 = 6'd8;
...
parameter [5:0] LEGUP_F_main_BB_lrphipreheader_35 = 6'd35;
parameter [5:0] LEGUP_F_main_BB_lrphipreheader_36 = 6'd36;
parameter [5:0] LEGUP_loop_pipeline_wait_loop5_1_37 = 6'd37;
parameter [5:0] LEGUP_F_main_BB__60_38 = 6'd38;
parameter [5:0] LEGUP_F_main_BB__62_39 = 6'd39;
parameter [5:0] LEGUP_F_main_BB__64_40 = 6'd40;
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_36)) begin
	...
	if ((cur_state == LEGUP_F_main_BB__62_39)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB__60_38:
		next_state = LEGUP_F_main_BB__64_40;
LEGUP_F_main_BB__62_39:
		next_state = LEGUP_F_main_BB__64_40;
LEGUP_F_main_BB__64_40:
		next_state = LEGUP_0;
...
LEGUP_F_main_BB_lrphipreheader_36:
	if ((main_lrphipreheader_53 == 1'd1))
		...
		next_state = LEGUP_F_main_BB__62_39;
...
LEGUP_F_main_BB_preheader2_8:
		next_state = LEGUP_loop_pipeline_wait_loop5_1_37;
LEGUP_loop_pipeline_wait_loop5_1_37:
...
always @(*) begin
	...
	/* main: %13*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %13 ], [ 0, %0 ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__13_12) & (memory_controller_waitrequest == 1'd0)) & (main_13_exitcond == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* main: %13*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %13 ], [ 0, %0 ]*/
	if ((((cur_state == LEGUP_F_main_BB__13_12) & (memory_controller_waitrequest == 1'd0)) & (main_13_exitcond == 1'd0))) begin
		main_13_indvar4_reg <= main_13_indvar4;
		if (start == 1'b0 && ^(main_13_indvar4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_13_indvar4_reg"); $finish; end
	end
end
...
always @(posedge clk) begin
	/* main: %.lr.ph.i.preheader*/
	/*   %50 = add nsw i32 %49, %48*/
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_35)) begin
...
always @(*) begin
	...
	start_time: 4 avail_time: 4 stage: 1 II: 4 start_ii_state = 4 % 4 = 0 avail_ii_state = 4 % 4 = 0*/
		main_54_scevgep3 = (`TAG_g_array_a + (4 * main_54_56_reg_stage1));
end
always @(*) begin
	/* main: %54*/
...
always @(posedge clk) begin
	...
	/* main: %64*/
	/*   ret i32 %51*/
	if ((cur_state == LEGUP_F_main_BB__64_40)) begin
...
always @(*) begin
	...
	/*   store i32 %16, i32* %scevgep6, align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB__13_11)) begin
		memory_controller_address_a = main_13_scevgep6_reg;
	end
	/* main: %.lr.ph.i.preheader*/
	/*   %28 = load i32* getelementptr inbounds ([100 x i32]* @array, i32 0, i32 0), align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_13)) begin
