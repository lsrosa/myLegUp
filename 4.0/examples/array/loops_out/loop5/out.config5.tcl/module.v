...
parameter [4:0] LEGUP_F_main_BB__13_8 = 5'd8;
...
parameter [4:0] LEGUP_loop_pipeline_wait_loop5_1_20 = 5'd20;
...
LEGUP_F_main_BB_preheader2_7:
		next_state = LEGUP_loop_pipeline_wait_loop5_1_20;
LEGUP_loop_pipeline_wait_loop5_1_20:
...
always @(*) begin
	...
	/* main: %13*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %13 ], [ 0, %0 ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB__13_10) & (memory_controller_waitrequest == 1'd0)) & (main_13_exitcond_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* main: %13*/
	/*   %indvar4 = phi i32 [ %indvar.next5, %13 ], [ 0, %0 ]*/
	if ((((cur_state == LEGUP_F_main_BB__13_10) & (memory_controller_waitrequest == 1'd0)) & (main_13_exitcond_reg == 1'd0))) begin
		main_13_indvar4_reg <= main_13_indvar4;
		if (start == 1'b0 && ^(main_13_indvar4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_13_indvar4_reg"); $finish; end
	end
end
...
always @(*) begin
	...
	start_time: 0 avail_time: 0 stage: 0 II: 3 start_ii_state = 0 % 3 = 0 avail_ii_state = 0 % 3 = 0*/
		main_54_scevgep = (1'd0 + (4 * main_54_55));
end
always @(posedge clk) begin
	/* main: %54*/
	/*   %scevgep = getelementptr [100 x i32]* @array, i32 0, i32 %55, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
...
always @(*) begin
	...
	start_time: 0 avail_time: 0 stage: 0 II: 3 start_ii_state = 0 % 3 = 0 avail_ii_state = 0 % 3 = 0*/
		main_54_scevgep3 = (1'd0 + (4 * main_54_56));
end
always @(posedge clk) begin
	/* main: %54*/
	/*   %scevgep3 = getelementptr [100 x i32]* @array, i32 0, i32 %56, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
...
always @(*) begin
	/* main: %54*/
	/*   %57 = load i32* %scevgep3, align 4, !tbaa !2, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !6, !legup.pipeline.stage !7
...
always @(*) begin
	/* main: %54*/
	/*   %58 = load i32* %scevgep2, align 4, !tbaa !2, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !6, !legup.pipeline.stage !7
	start_time: 0 avail_time: 1 stage: 0 II: 3 start_ii_state = 0 % 3 = 0 avail_ii_state = 1 % 3 = 1*/
...
always @(posedge clk) begin
	/* main: %54*/
	/*   %59 = mul nsw i32 %58, %57, !legup.pipeline.start_time !6, !legup.pipeline.avail_time !8, !legup.pipeline.stage !7
...
always @(posedge clk) begin
	if ((cur_state == LEGUP_loop_pipeline_wait_loop5_1_20)) begin
...
always @(*) begin
	...
	if ((cur_state == LEGUP_F_main_BB__13_9)) begin
		array_address_a = (main_13_scevgep6 >>> 3'd2);
	end
	/* main: %.lr.ph.i.preheader*/
	/*   %28 = load i32* getelementptr inbounds ([100 x i32]* @array, i32 0, i32 0), align 4, !tbaa !2*/
	if ((cur_state == LEGUP_F_main_BB_lrphipreheader_11)) begin
...
always @(*) begin
	...
	/* main: %54*/
	/*   store i32 %59, i32* %scevgep, align 4, !tbaa !2, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !7
	start_time: 2 avail_time: 3 stage: 0 II: 3 start_ii_state = 2 % 3 = 2 avail_ii_state = 3 % 3 = 0*/
	if (((loop5_1_ii_state == 2'd2) & loop5_1_valid_bit_2)) begin
		array_address_b = (main_54_scevgep_reg_stage0 >>> 3'd2);
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop5_1_epilogue & (~(loop5_1_valid_bit_2) & loop5_1_valid_bit_3)))) begin
		loop5_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_started"); $finish; end
	end
end
...
always @(*) begin
	loop5_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop5_1_epilogue & (~(loop5_1_valid_bit_2) & loop5_1_valid_bit_3)));
end
always @(*) begin
