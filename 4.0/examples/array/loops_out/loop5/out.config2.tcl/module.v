...
parameter [4:0] LEGUP_loop_pipeline_wait_loop5_1_22 = 5'd22;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] main_54_scevgep_reg_stage0;
...
LEGUP_F_main_BB_preheader2_8:
		next_state = LEGUP_loop_pipeline_wait_loop5_1_22;
LEGUP_loop_pipeline_wait_loop5_1_22:
...
always @(*) begin
	/* main: %54*/
	/*   %55 = add i32 %indvar, 1, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
	start_time: 0 avail_time: 0 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 0 % 4 = 0*/
		main_54_55 = (loop5_1_i_stage0 + 32'd1);
end
always @(*) begin
	/* main: %54*/
	/*   %scevgep = getelementptr [100 x i32]* @array, i32 0, i32 %55, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7
	start_time: 0 avail_time: 0 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 0 % 4 = 0*/
		main_54_scevgep = (`TAG_g_array_a + (4 * main_54_55));
end
always @(*) begin
	/* main: %54*/
...
always @(*) begin
	/* main: %54*/
	/*   %57 = load i32* %scevgep3, align 4, !tbaa !2, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !8, !legup.pipeline.stage !7
	start_time: 0 avail_time: 2 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 2 % 4 = 2*/
		main_54_57 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* main: %54*/
	/*   %58 = load i32* %scevgep2, align 4, !tbaa !2, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !8, !legup.pipeline.stage !7
	start_time: 0 avail_time: 2 stage: 0 II: 4 start_ii_state = 0 % 4 = 0 avail_ii_state = 2 % 4 = 2*/
...
always @(posedge clk) begin
	...
	if (((memory_controller_waitrequest == 1'd0) & (loop5_1_epilogue & (~(loop5_1_valid_bit_3) & loop5_1_valid_bit_4)))) begin
		loop5_1_started <= 1'd0;
		if (start == 1'b0 && ^(1'd0) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to loop5_1_started"); $finish; end
	end
end
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop5_1_ii_state == 2'd0) & loop5_1_valid_bit_0))) begin
		main_54_scevgep_reg_stage0 <= main_54_scevgep;
		if (start == 1'b0 && ^(main_54_scevgep) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_54_scevgep_reg_stage0"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	loop5_1_pipeline_finish = ((memory_controller_waitrequest == 1'd0) & (loop5_1_epilogue & (~(loop5_1_valid_bit_3) & loop5_1_valid_bit_4)));
end
always @(*) begin
...
always @(posedge clk) begin
	/* main: %54*/
	/*   %59 = mul nsw i32 %58, %57, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !7
...
always @(*) begin
	...
	/* main: %54*/
	/*   store i32 %59, i32* %scevgep, align 4, !tbaa !2, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !10, !legup.pipeline.stage !7
	start_time: 3 avail_time: 4 stage: 0 II: 4 start_ii_state = 3 % 4 = 3 avail_ii_state = 4 % 4 = 0*/
	if (((loop5_1_ii_state == 2'd3) & loop5_1_valid_bit_3)) begin
		memory_controller_enable_b = 1'd1;
	end
end
always @(*) begin
	...
	start_time: 3 avail_time: 4 stage: 0 II: 4 start_ii_state = 3 % 4 = 3 avail_ii_state = 4 % 4 = 0*/
	if (((loop5_1_ii_state == 2'd3) & loop5_1_valid_bit_3)) begin
		memory_controller_address_b = main_54_scevgep_reg_stage0;
	end
end
always @(*) begin
