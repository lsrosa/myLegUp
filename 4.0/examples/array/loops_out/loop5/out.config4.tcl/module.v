...
parameter [4:0] LEGUP_loop_pipeline_wait_loop5_1_23 = 5'd23;
...
LEGUP_F_main_BB_preheader2_7:
		next_state = LEGUP_loop_pipeline_wait_loop5_1_23;
LEGUP_loop_pipeline_wait_loop5_1_23:
...
always @(*) begin
	/* main: %54*/
	/*   %58 = load i32* %scevgep2, align 4, !tbaa !2, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !9, !legup.pipeline.stage !6
...
always @(posedge clk) begin
	/* main: %54*/
	/*   %59 = mul nsw i32 %58, %57, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !10, !legup.pipeline.stage !6
...
always @(posedge clk) begin
	if ((cur_state == LEGUP_loop_pipeline_wait_loop5_1_23)) begin
...
always @(*) begin
	...
	/* main: %54*/
	/*   store i32 %59, i32* %scevgep, align 4, !tbaa !2, !legup.pipeline.start_time !10, !legup.pipeline.avail_time !11, !legup.pipeline.stage !6
