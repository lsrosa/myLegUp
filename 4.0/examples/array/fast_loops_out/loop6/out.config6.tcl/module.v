...
always @(posedge clk) begin
	/* main: %1*/
	/*   %9 = sdiv i32 %8, %7, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !13, !legup.pipeline.stage !14
	start_time: 34 avail_time: 66 stage: 8 II: 4 start_ii_state = 34 % 4 = 2 avail_ii_state = 66 % 4 = 2*/
	if ((~(memory_controller_waitrequest) & ((loop6_1_ii_state == 2'd2) & loop6_1_valid_bit_66))) begin
...
always @(*) begin
	...
	/* main: %1*/
	/*   store volatile i32 %9, i32* %scevgep2, align 4, !tbaa !6, !legup.pipeline.start_time !13, !legup.pipeline.avail_time !4, !legup.pipeline.stage !5
...
always @(posedge clk) begin
	if (((memory_controller_waitrequest == 1'd0) & ((loop6_1_ii_state == 2'd1) & loop6_1_valid_bit_33))) begin
		main_1_7_reg_stage8 <= main_1_7;
		if (start == 1'b0 && ^(main_1_7) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_7_reg_stage8"); $finish; end
	end
end
always @(posedge clk) begin
...
always @(*) begin
	...
	/*   %9 = sdiv i32 %8, %7, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !13, !legup.pipeline.stage !14
	start_time: 34 avail_time: 66 stage: 8 II: 4 start_ii_state = 34 % 4 = 2 avail_ii_state = 66 % 4 = 2*/
	else /* if (((loop6_1_ii_state == 2'd2) & loop6_1_valid_bit_34)) */ begin
...
always @(*) begin
	...
	start_time: 34 avail_time: 66 stage: 8 II: 4 start_ii_state = 34 % 4 = 2 avail_ii_state = 66 % 4 = 2*/
		...
		main_signed_divide_32_0_op1 = main_1_7_reg_stage8;
	end
end
always @(*) begin
