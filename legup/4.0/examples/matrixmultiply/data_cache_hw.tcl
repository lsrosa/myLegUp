...
add_interface_port dataMaster0 avm_dataMaster0_burstcount burstcount Output 6
...
add_interface CACHE1 avalon end
set_interface_property CACHE1 addressAlignment DYNAMIC
set_interface_property CACHE1 addressUnits WORDS
set_interface_property CACHE1 associatedClock clockreset
set_interface_property CACHE1 burstOnBurstBoundariesOnly false
set_interface_property CACHE1 explicitAddressSpan 0
set_interface_property CACHE1 holdTime 0
set_interface_property CACHE1 isMemoryDevice false
set_interface_property CACHE1 isNonVolatileStorage false
set_interface_property CACHE1 linewrapBursts false
set_interface_property CACHE1 maximumPendingReadTransactions 0
set_interface_property CACHE1 printableDevice false
set_interface_property CACHE1 readLatency 0
set_interface_property CACHE1 readWaitTime 1
set_interface_property CACHE1 setupTime 0
set_interface_property CACHE1 timingUnits Cycles
set_interface_property CACHE1 writeWaitTime 0
set_interface_property CACHE1 ENABLED true

add_interface_port CACHE1 avs_CACHE1_begintransfer begintransfer Input 1
add_interface_port CACHE1 avs_CACHE1_read read Input 1
add_interface_port CACHE1 avs_CACHE1_write write Input 1
add_interface_port CACHE1 avs_CACHE1_writedata writedata Input 128
add_interface_port CACHE1 avs_CACHE1_readdata readdata Output 128
add_interface_port CACHE1 avs_CACHE1_waitrequest waitrequest Output 1

add_interface dataMaster1 avalon start
set_interface_property dataMaster1 addressUnits SYMBOLS
set_interface_property dataMaster1 associatedClock clockreset
set_interface_property dataMaster1 burstOnBurstBoundariesOnly false
set_interface_property dataMaster1 doStreamReads false
set_interface_property dataMaster1 doStreamWrites false
set_interface_property dataMaster1 linewrapBursts false
set_interface_property dataMaster1 readLatency 0
set_interface_property dataMaster1 ENABLED true

add_interface_port dataMaster1 avm_dataMaster1_read read Output 1
add_interface_port dataMaster1 avm_dataMaster1_write write Output 1
add_interface_port dataMaster1 avm_dataMaster1_address address Output 32
add_interface_port dataMaster1 avm_dataMaster1_writedata writedata Output 32
add_interface_port dataMaster1 avm_dataMaster1_byteenable byteenable Output 4
add_interface_port dataMaster1 avm_dataMaster1_readdata readdata Input 32
add_interface_port dataMaster1 avm_dataMaster1_beginbursttransfer beginbursttransfer Output 1
add_interface_port dataMaster1 avm_dataMaster1_burstcount burstcount Output 6
add_interface_port dataMaster1 avm_dataMaster1_waitrequest waitrequest Input 1
add_interface_port dataMaster1 avm_dataMaster1_readdatavalid readdatavalid Input 1
